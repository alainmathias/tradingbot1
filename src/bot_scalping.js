...
const { getCandles } = require('./market_scalping');
...
const {
    getScore,
    getSignal
} = require('./strategy_scalping');

const {
    canTrade
} = require('./risk_scalping');
...
console.log("🔥 BEFORE OPENTRADE");
await portfolio.openTrade(
    signal,
    currentPrice,
    size
);
